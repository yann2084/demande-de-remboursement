<?php
include("template/top.view.php");
?>

<body onLoad="init()">

<?php
include("template/menu.view.php");
?>
    ...
    <div class="container-fluid">
        ...
        <form class="form col-md-10 col-md-offset-1" role="form" id="odmForm" method="post" action="../controler/traitement.ctrl.php">
            ...
            <div class="form-group well" style="background-color:lavender;" id="statutDiv">
                <div class="well"><h4><span class="glyphicon glyphicon-user"></span> Votre statut<em> *</em></h4>
                    <div class="row">
                        <div class="col-sm-4 well" style="background-color:lavender;">
                            <label class="radio-inline" for="personnel"><input type="radio" id="personnel" value="Personnel" name="statut_user" required>Personnel / Stagiaire</label>
                ...
                <div class="well">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="lieu_depl" name="lieu_depl" value="" data-toggle="tooltip" placeholder="Entrer le lieu de votre déplacement" required>
                    </div>
                </div>
...
<!--        <button type="button" class="btn btn6 btn-warning"><span class="glyphicon glyphicon-repeat"></span> RÉINITIALISER</button>
-->        <button type="submit" class="submit btn btn-success" onClick="afficheAll()"><span class="glyphicon glyphicon-ok"></span> Enregistrer</button>
    </div>
</div>
...
<?php
include("template/bottom.view.php");
?>
