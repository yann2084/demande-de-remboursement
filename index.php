...
function droits($sqlserveur,$sqluti,$sqlmdp,$sqlbd,$email,$prenom,$nom,$uid) {
...
//			header("Location: controler/accueil.ctrl.php?prenom=$prenom&nom=$nom&droit=$droit&email=$email&uid=$uid");
			header("Location: modules/accueil/accueil.ctrl.php");
				...
				$_SESSION['email'] = $email;
//				header("Location: controler/accueil.ctrl.php?prenom=$prenom&nom=$nom&droit=$droit&email=$email&uid=$uid");
				header("Location: modules/accueil/controler/accueil.ctrl.php");
	}
	mysql_close($lien);
	exit;
}
...
echo "<!-- Retour de mission : Demance de remboursement -->
<html><head>
...
<tr>
<td align=center><img border=\"0\" src=\"data/img/pagora.jpg\"><br></TD>
<td align=center><img border=\"0\" src=\"data/img/AGEFPI.jpg\"><br></TD>
<td align=center><img border=\"0\" src=\"data/img/LGP2.jpg\"><br></TD>
</tr>
</table>
</td>
</tr>
...
<TD>
<BR><BR>
<FONT SIZE=5>Bienvenue dans l'application [-Retour de mission -> Demande de remboursement]</FONT>
<BR><BR>
</td>
</tr>
<tr>
		...
		if ($pos === false) {
			...
			echo "l'adresse mail doit être soit pagora.grenoble-inp.fr, soit lgp2.grenoble-inp.fr";
				...
				echo "<center><SPAN STYLE='font-size: 14px; background: #DE6661:;; color:white;'>Mot de passe incorrect</SPAN></center><br>";
					...
					$bidon=droits($sqlserveur,$sqluti,$sqlmdp,$sqlbd,$email,$prenom,$nom,$uid);
			...
			if (!$bindServerLDAP)
			echo "<center><SPAN STYLE='font-size: 14px; background: #DE6661; color:white;'>Mot de passe incorrect</SPAN></center><br>";
			else $bidon=droits($sqlserveur,$sqluti,$sqlmdp,$sqlbd,$email,$prenom,$nom,$uid);
		}
	}
	else {
	...
	<td width=80% align="left" valign="middle" >
		<TABLE border=0 cellPadding=0 cellSpacing=0 width =100% bgcolor="#d6e6f6">
			<FORM action="index.php" onsubmit="return Validation_saisie(this)" method="post" name="identification">
				...
				<TR>
					...
					<TR>
						...
						<TR>
							<TD colspan=2 align=center><br><INPUT alt=OK border=0 height=20 src="data/img/ok.gif" type=image width=36>&nbsp;&nbsp;</TD>
							</TR>
						</FORM>
					</TABLE>
				</td>
			...
			<tr>
				...
				<TD>
					<BR><BR>
						En cas de probl&egrave;me <a href="mailto:Mazen.Mahrous@Pagora.Grenoble-inp.fr">Contacter l'administrateur</a>
						<BR><BR>
						</td>
					</tr>
				</TABLE>
